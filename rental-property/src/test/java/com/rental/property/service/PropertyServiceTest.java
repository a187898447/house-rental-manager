...
class PropertyServiceTest {
    ...
    void testCreateProperty_Success() {
        ...
        // Act
        Long propertyId = propertyService.createProperty(testDTO);
    ...
    @Test
    void testCreateProperty_NullDTO() {
        // Arrange & Act & Assert
        assertThrows(IllegalArgumentException.class, () -> {
            propertyService.createProperty(null);
        });
    }
    ...
    void testUpdateProperty_Success() {
        ...
        updateDTO.setRent(new BigDecimal("3500.00"));
    ...
    void testUpdateProperty_NotFound() {
        ...
        // Act & Assert
        assertThrows(IllegalArgumentException.class, () -> {
            propertyService.updateProperty(999L, updateDTO);
        });
    }
